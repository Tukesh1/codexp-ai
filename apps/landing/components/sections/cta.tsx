  ...
  return (
    <section className="relative overflow-hidden border-t border-[var(--line)]">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-24 md:px-6 md:py-32">
        <h2 className="max-w-2xl font-[family-name:var(--font-display)] text-3xl font-bold tracking-tight text-[var(--fg)] md:text-5xl md:leading-[1.1]">
        ...
        <p className="mt-6 font-[family-name:var(--font-mono)] text-xs text-[var(--fg-muted)]">
